  ...
  return nowPlay.length>0 ?(
    <>
              ...
              duration-300' onClick={()=>setSelectedMovie(movie.id)}>
                <div className='relative rounded-lg overflow-hidden'>
                  ...
                  p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                    <p className='flex items-center gap-1 tet-gray-400'>
       ...
       <div className='mt-8'>
        ...
        p-1 pl-3 rounded-lg'>
          ...
          <input type="dateTime-local"  value={dateInput} onChange={(e)=>setDateInput(e.target.value)}
           ...
           <button onClick={handleDateTime} className='bg-primary/80 text-white px-3
     ...
     <button className='bg-primary text-white px-8
           py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>Add Show</button>
    </>
  ):<Loading/>
}
